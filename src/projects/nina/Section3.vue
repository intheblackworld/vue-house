  ...
  <div>
    <div class="section3">
     <div class="c" data-aos="fade" data-aos-delay="0" data-aos-duration="1900">
      <img src="./all/7.png" alt="探索航空城的無限可能" class="c7">
      <img src="./all/6.png" alt="探索航空城的無限可能" class="c6">
      <img src="./all/3.png" alt="探索航空城的無限可能" class="c3">
      <img src="./all/2.png" alt="探索航空城的無限可能" class="c2">
    </div>
      ...
      <div class="txt">
      <div class="title" data-aos="fade-down" data-aos-delay="200" >探索航空城的無限可能</div>
      </div>
    </div>
  </div>
</template>
