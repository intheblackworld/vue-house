<template>
  <div class="section4">
    ...
    <div class="block-desc"  data-aos="fade-up" data-aos-delay="800">
      買房，跟著交通建設走就對了！［立瑾綻］距鳳鳴正式站約400公尺，臨時站約700公尺，現在進駐正是時候！ 
    </div>
  </div>
</template>
...
.content-block {
  ...
  background-image: url('./s4/04_font_box.png');
  background-size: cover;
}

.block-hr {
  @include img_r_pc(53, 888, 657);
  border-bottom: solid size(4) #009fb1;
}

.block-title {
  @include img_r_pc(384, 856, 244);
  font-size: size(40.5);
  font-weight: 500;
  font-stretch: normal;
  font-style: normal;
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s4/04_slider_01.jpg'),
          name: '台鐵鳳鳴站示意圖（截取自新北市政府施政成果網）',
        },
        {
          img: require('./s4/04_slider_02.jpg'),
          name: '台鐵鳳鳴站示意圖（截取自新北市政府施政成果網）',
        },
      ],
    }
