<template>
  <div class="section1">
    ...
    <h1 class="title" v-if="isPC" data-aos="fade-up" data-aos-delay="200">鳳鳴站前 電梯豪墅</h1>
    ...
    <div class="subtitle" v-if="isMobile">
      ...
      <h3 class="subtitle2 flex-ac wrap" data-aos="fade-up" data-aos-delay="600" >極致禮遇 頂規建材<br /><span class="flex-ac">Is Living A Happy Life</span></h3>
    </div>
  </div>
</template>
