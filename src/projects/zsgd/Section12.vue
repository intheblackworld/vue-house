  ...
  <div class="section12">
    ...
    <div class="video" v-if="isDialog && isMobile">
      <div class="video_dialog" @click="isDialog = false">
        <iframe title="youtube" src="https://www.youtube.com/embed/8cA58857UwU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
...
.video_box {
  width: 100%;
  position: absolute;
  background: url('./s12/v.jpg') no-repeat center;
