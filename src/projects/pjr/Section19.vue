<template>
  <div class="section19">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      深受劇場美學薰陶，擅解構空間既有元素，重建光影層次，輝映本案地標價值。<br /><br />代表作品：璞真一一、富富話合、忠泰味、君悅酒店
    </h3>
    <div class="title" v-if="isPC" data-aos="fade-up" data-aos-delay="200">
      光雕美學詩人<br />肯緒照明設計－林世秉
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s12/4/1.jpg'),
          name: '肯緒照明設計 林世秉',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s12/4/2.jpg'),
          name: '肯緒照明設計 林世秉',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s12/4/3.jpg'),
          name: '肯緒照明設計 林世秉',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s12/4/4.jpg'),
          name: '肯緒照明設計 林世秉',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s12/4/5.jpg'),
          name: '肯緒照明設計 林世秉',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
      ],
