<template>
  <div class="section13">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      關上大道簇擁的歡騰，尋咖啡香拜訪古蹟藝術聚落，當代藝術館、台北光點、蔡瑞月舞蹈社、台北美術館，沉浸國內外特展、獨家藝術電影，玻璃屋裡狂舞的青春，百年建築與當代藝術厚植底蘊，探不盡的人文靈光。
    </h3>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s11/3/1.jpg'),
          name: '中山北路實景',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s11/3/2.jpg'),
          name: '中山北路實景',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s11/3/3.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s11/3/4.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
      ],
