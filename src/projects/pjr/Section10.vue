  ...
  <div class="section10">
    <div class="container flex flex-jb flex-ac wrap">
      <div class="swipe" @mouseenter.stop="toggleTimer = false" @mouseleave.stop="toggleTimer = true" data-aos="fade-down" data-aos-delay="400">
        ...
        <div class="flex-ac">
          <picture>
            <source srcset="./s10/1-0.jpg" type="image/webp" />
            <source srcset="./webp/s10/1-0.webp" type="image/jpeg" />
            <img src="./s10/1-0.jpg" :alt="info.caseName" class="avatar">
          </picture>
          <div class="content">
            <div class="label">
              建築規劃｜陳金水建築師事務所 陳金水
            ...
            <h3 class="desc">
              曾獲美國建築師協會Henry_Adams獎章，執業超過二十年，擅以現代創新筆法回應地景脈絡，締造與自然相契的建築作品。<br /><br />
              代表作品：九昱晴美、祥德帝寶、旺洲旺年匯、綺華有仁愛
            </h3>
          </div>
        </div>
      </div>
      <div class="swipe" @mouseenter.stop="toggleTimer = false" @mouseleave.stop="toggleTimer = true" data-aos="fade-down" data-aos-delay="600">
        <div class="flex-ac">
          <picture>
            <source srcset="./s10/2-0.jpg" type="image/webp" />
            <source srcset="./webp/s10/2-0.webp" type="image/jpeg" />
            <img src="./s10/2-0.jpg" :alt="info.caseName" class="avatar">
          </picture>
          <div class="content">
            <div class="label">
              空間規劃｜萊比空間設計 施秋蓮
            ...
            <h3 class="desc">
              創立近二十年，集結頂尖設計團隊，深刻磨砥空間美學，從居者的生命體驗起始，巧妙契合實用機能與感官饗宴，重新定義家的奢華本質。<br /><br />
              代表作品│璞真仰睦、岳泰峰範、全陽柏悅
            </h3>
          </div>
        </div>
      ...
      <div class="swipe" @mouseenter.stop="toggleTimer = false" @mouseleave.stop="toggleTimer = true" data-aos="fade-down" data-aos-delay="800">
        ...
        <div class="flex-ac">
          <picture>
            <source srcset="./s10/3-0.jpg" type="image/webp" />
            <source srcset="./webp/s10/3-0.webp" type="image/jpeg" />
            <img src="./s10/3-0.jpg" :alt="info.caseName" class="avatar">
          </picture>
          <div class="content">
            <div class="label">
              景觀設計｜頤和景觀 李淑雲
            ...
            <h3 class="desc">
              秉承當代景觀設計思潮，呼應中山北路浩瀚樹海地景，創造都市、建築、人文、生態深度共鳴，譜寫人居環境與自然萬物的優雅格調。<br /><br />
              代表作品：璞真碧湖畔、華固名鑄、華固天鑄、華固樂慕
            </h3>
          </div>
        </div>
      </div>
      <div class="swipe" @mouseenter.stop="toggleTimer = false" @mouseleave.stop="toggleTimer = true" data-aos="fade-down" data-aos-delay="1200">
        <div class="flex-ac">
          <picture>
            <source srcset="./s10/4-0.jpg" type="image/webp" />
            <source srcset="./webp/s10/4-0.webp" type="image/jpeg" />
            <img src="./s10/4-0.jpg" :alt="info.caseName" class="avatar">
          </picture>
          <div class="content">
            <div class="label">
              燈光規劃｜肯緒照明設計 林世秉
            ...
            <h3 class="desc">
              長年深受劇場美學薰陶，擅長解構空間既有元素，伴隨自然與日夜星辰流轉，重建光影環境與視覺層次，彰顯璞真之道地標價值。<br /><br />
              代表作品：璞真一一、富富話合、忠泰味、君悅酒店
            </h3>
          </div>
        </div>
...
.avatar {
  width: size(180);
  margin-right: size(47.6);

  @include md {
    @include img_l_m(115, 131, 0);
  }
}
...
export default {
  ...
  data() {
    return {
      ...
      slideList1: [
        {
          img: require('./s10/1-1九昱晴美.jpg'),
          name: '九昱晴美',
          webp: require('./webp/s10/1-1九昱晴美.webp'),
        },
        {
          img: require('./s10/1-2綺華有仁愛外觀3D示意.jpg'),
          name: '綺華有仁愛外觀3D示意',
          webp: require('./webp/s10/1-2綺華有仁愛外觀3D示意.webp'),
        },
        {
          img: require('./s10/1-3祥德帝寶外觀3D示意.jpg'),
          name: '祥德帝寶外觀3D示意',
          webp: require('./webp/s10/1-3祥德帝寶外觀3D示意.webp'),
        },
      ],
      slideList2: [
        {
          img: require('./s10/2-1璞真仰睦.jpg'),
          name: '璞真仰睦',
          webp: require('./webp/s10/2-1璞真仰睦.webp'),
        },
        {
          img: require('./s10/2-2全陽柏悅.jpg'),
          name: '全陽柏悅',
          webp: require('./webp/s10/2-2全陽柏悅.webp'),
        },
        {
          img: require('./s10/2-3岳泰峰範.jpg'),
          name: '岳泰峰範',
          webp: require('./webp/s10/2-3岳泰峰範.webp'),
        },
      ],
      slideList3: [
        {
          img: require('./s10/3-1璞真碧湖畔.jpg'),
          name: '璞真碧湖畔',
          webp: require('./webp/s10/3-1璞真碧湖畔.webp'),
        },
        {
          img: require('./s10/3-2華固樂慕.jpg'),
          name: '華固樂慕',
          webp: require('./webp/s10/3-2華固樂慕.webp'),
        },
        {
          img: require('./s10/3-3華固名鑄.jpg'),
          name: '華固名鑄',
          webp: require('./webp/s10/3-3華固名鑄.webp'),
        },
        {
          img: require('./s10/3-4華固天鑄.jpg'),
          name: '華固天鑄',
          webp: require('./webp/s10/3-4華固天鑄.webp'),
        },
      ],
      slideList4: [
        {
          img: require('./s10/4-1璞真一一.jpg'),
          name: '璞真一一',
          webp: require('./webp/s10/4-1璞真一一.webp'),
        },
        {
          img: require('./s10/4-2富富話合.jpg'),
          name: '富富話合',
          webp: require('./webp/s10/4-2富富話合.webp'),
        },
        {
          img: require('./s10/4-3忠泰味.jpg'),
          name: '忠泰味',
          webp: require('./webp/s10/4-3忠泰味.webp'),
        },
        {
          img: require('./s10/4-4君悅酒店.jpg'),
          name: '君悅酒店',
          webp: require('./webp/s10/4-4君悅酒店.webp'),
        },
      ],
    }
  },
