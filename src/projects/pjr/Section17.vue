<template>
  <div class="section17">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      創立近二十載，從居者生命體驗起始，糅合實用機能與感官體驗，重譯奢華本質。<br /><br />代表作品：璞真仰睦、岳泰峰範、全陽柏岳
    </h3>
    <div class="title" v-if="isPC" data-aos="fade-up" data-aos-delay="200">
      留美設計藝匠<br />萊比空間設計－施秋蓮
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s12/2/1.jpg'),
          name: '萊比設計 施秋蓮',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s12/2/2.jpg'),
          name: '萊比設計 施秋蓮',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s12/2/3.jpg'),
          name: '萊比設計 施秋蓮',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s12/2/4.jpg'),
          name: '萊比設計 施秋蓮',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
      ],
