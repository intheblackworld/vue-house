<template>
  <div class="section15">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      大時代風華續行，新榮景蓄勢待發，上海商銀、陽信銀行雙金融總部改建如火如荼，落址中山、民權十字金脈，第一大道再添榮耀。起首中山北路，權掌松山國際機場、台北雙子星雙國門，佈局亞太經貿版圖，「台北雙子星」600億盛大開發，地上74層、56層摩天雙塔，結合百貨、旅館、頂辦，燃亮北市新未來。
    </h3>
    <div class="title" v-if="isPC" data-aos="fade-up" data-aos-delay="200">
      上海、陽信雙金融總部<br />雙國門輻輳，第一大道再鑲榮耀
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s11/5/1.jpg'),
          name: '中山北路實景',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s11/5/2.jpg'),
          name: '中山北路實景',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s11/5/3.jpg'),
          name: '中山北路實景',
