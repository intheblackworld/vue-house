<template>
  <div class="section14">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      昂首中山北路，國際五星飯店沿途磅礡坐落，全球高官政要、富商大賈匯聚的優渥，國賓飯店、晶華酒店、老爺大酒店、大倉久和、圓山大飯店，建築藝境、經典饗饌、極致款待，詮釋中山北路的頂級奢華。
    </h3>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s11/4/1.jpg'),
          name: '中山北路實景',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s11/4/2.jpg'),
          name: '中山北路實景',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s11/4/3.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s11/4/4.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s11/4/5.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
      ],
