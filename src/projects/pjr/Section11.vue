<template>
  <div class="section11">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      漫步中山、晶華旗艦商圈，國際精品櫥窗競豔，全球限量才與您匹配；穿梭赤峰街巷，時尚、美饌與老屋風情交織，再來場甜點約會。品嚐台北最有滋味的日常，優雅米其林摘星，拐彎是道地庶民小吃，經典圓仔湯、快炒沙茶牛，行經時光風味依舊；寧夏夜市小吃攤並肩，蝦仁蛋包湯、知高飯，置身台北上河圖。
    </h3>
    <div class="title" v-if="isPC" data-aos="fade-up" data-aos-delay="200">
      東京青山品味，盛裝優雅時光<br />雙連生活圈，難忘市井好滋味
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s11/1/1.jpg'),
          name: '中山北路實景',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s11/1/2.jpg'),
          name: '中山北路實景',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s11/1/3.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s11/1/4.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s11/1/5.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s11/1/6.jpg'),
          name: '中山北路實景',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
      ],
