...
/* Swipe */
.swipe {
  @include div_l_pc(660, 660, 120, 185);
  object-fit: cover;
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s5/1情境示意圖.jpg'),
          imgm: require('./s5/1情境示意圖.jpg'),
        ...
        {
          img: require('./s5/2情境示意圖.jpg'),
          imgm: require('./s5/2情境示意圖.jpg'),
          webp: require('./webp/s5/2情境示意圖.webp'),
          webpm: require('./webp/s5/2情境示意圖.webp'),
          name: '情境示意圖',
