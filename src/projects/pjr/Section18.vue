<template>
  <div class="section18">
    <h3 class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="400">
      秉承當代景觀設計思潮，呼應樹海地景，譜寫人居環境與自然萬物的優雅基調。<br /><br />代表作品：璞真碧湖畔、華固名鑄、華固天鑄、華固樂慕
    </h3>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          img: require('./s12/3/1.jpg'),
          name: '頤和景觀 李淑雲',
          // desc: '270度翠綠簇擁<br />開窗就享無垠綠景',
        },
        {
          img: require('./s12/3/2.jpg'),
          name: '頤和景觀 李淑雲',
          // desc: '大福路大興路環抱<br />地段價值更珍貴',
        },
        {
          img: require('./s12/3/3.jpg'),
          name: '頤和景觀 李淑雲',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s12/3/4.jpg'),
          name: '頤和景觀 李淑雲',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
        {
          img: require('./s12/3/5.jpg'),
          name: '頤和景觀 李淑雲',
          // desc: '埔心溪緩緩河廊<br />228紀念公園樹廊',
        },
      ],
