  ...
  <div>
    <div class="section5">
     ...
     <!--  --><div class="pagination absolute flex-ac" data-aos="fade-up" data-aos-delay="500" v-if="isPC">
      ...
      <div class="txt">
      <div class="title" data-aos="fade-up" data-aos-delay="200">採買多元便利</div>
      <div class="subtitle" data-aos="fade-up" data-aos-delay="200">家樂福車行約4分　樹林車站前商圈車行約4分</div>

      <div class="linestyle" data-aos="fade-up" data-aos-delay="200">
        <div class="lineicon"> <img src="./s5/lineicon.png" alt=""/> </div>
      </div>

      <div class="desc" data-aos="fade-up" data-aos-delay="300">中山路商圈的特色小吃、家樂福量販採購、樹林車站商圈周邊的全聯、寶雅、星巴克、秀泰影城、夜市，坐享豐富機能。
</div>
      </div>
    </div>
  </div>
