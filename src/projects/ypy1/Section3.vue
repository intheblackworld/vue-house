...
@media screen and (max-width: 767px) {
  ...
  .hr {
    @include img_l_m(4, 49, 34);
    height: sizem(62);
    background: #000;
  }

  .label {
    @include img_l_m(84, 45, 45);
    font-size: sizem(21);
    font-weight: 500;
    font-stretch: normal;
    font-style: normal;
