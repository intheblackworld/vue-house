<template>
  <div>
    <div class="section9">
      ...
      <img loading="lazy" src="./all/2.png" :alt="`${info.caseName}_bg`" class="c2">
    </div>
...
.c{
    ...
    .c2{width:size(319);top:size(1100);left: size(0);transform: translateX(-20%);animation-delay: -2s;}
  }
...
.c{
    .c2{width:sizem(150);top:sizem(300);left: sizem(10);}
}
