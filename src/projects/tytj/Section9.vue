...
.border {
  ...
  top: size(300);
  right: size(43);
  box-shadow: inset 0 0 0 3px #68361a;
}
      ...
      slideList: [
        {
          ...
          title: '耶鲁鎖-原廠保固<br />2年24hr售後服務',
          subtitle: '世界最大 美國第一',
          desc:
            '百年經典品牌及鎖具専家，耶鲁以百年製鎖經驗，結合創新技術，生產各式鎖具及保安產品。銷售全球超過125個國家，為每個家庭及企業提供最完善的保障。以最先進的科技成果，為您免去隨身攜帶鑰匙不便，用戶透過自己的智慧型手機確保居家安全。',
        },
        {
