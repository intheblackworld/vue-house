<template>
  <div class="section8">
    <img loading="lazy" src="./s8/o.png" :alt="`${info.caseName}_img`" class="o">
    ...
    <div class="hr"></div>
    <div class="desc">
      專注將建築與文化、美學合而為一，真誠而不做作，堅持打造深度融入地方生活、體現精煉文化的經典建築。
    </div>
  </div>
</template>
...
.title {
  ...
  font-style: normal;
  line-height: 1.09;
  letter-spacing: size(5.58);
  text-align: left;
  color: #c3985b;
  white-space: nowrap;
}
.subtitle {
  @include img_l_pc(317, 0, 930);
  top: auto;
  bottom: size(159);
  font-size: size(37);
  font-weight: bold;
