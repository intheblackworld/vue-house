<template>
  <div class="section1">
    <img src="../shin-lan/process/topbg.jpg" alt="" class="bg-img" v-if="isPC">
    <img src="../shin-lan/mo/process/topbg.jpg" alt="" class="bg-img" v-else>
    <div class="shin-lan-title-v shin-lan-title-v-m title gold" data-aos="fade">
