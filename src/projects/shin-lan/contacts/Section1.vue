<template>
  <div class="section1">
    <img src="../shin-lan/contacts/topbg.jpg" alt="" class="bg-img" v-if="isPC">
    <img src="../shin-lan/mo/contacts/topbg.jpg" alt="" class="bg-img" v-else>
