...
.move {
  ...
  &:nth-child(7) {
    animation: updown 1.5s .7s ease-in-out infinite alternate;
  }

  &:nth-child(8) {
    animation: updown 1.5s 1s ease-in-out infinite alternate;
  }

  &:nth-child(9) {
    animation: updown 1.5s .4s ease-in-out infinite alternate;
  }
}
