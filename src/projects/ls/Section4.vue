  ...
  <div>
    <div class="section4">
      <div class="box">
        ...
        <img src="./s1/start2.png" class="start2" />
      </div>
     ...
     <!--  --><div class="pagination absolute flex-ac" v-if="isPC">
      ...
      <div class="txt">
      <div class="title" data-aos="fade-up" data-aos-delay="200">散步全聯<br v-if="isMobile" />  近享日月光廣場</div>
      <div class="desc" data-aos="fade-up" data-aos-delay="300">【樂晴】輕鬆步行即達全聯、麥當勞商圈，假日放鬆一下，來去樹林夜市、秀泰影城，或者直奔日月光廣場，從在地小吃到精品美食，盡享繽紛樂趣。
</div>
      </div>
    </div>
  </div>
...
.start1{
    position: absolute;
    top:size(230);right:size(-10);
    font-size:size(22);
filter: drop-shadow(0em 0.1em 0.15em rgba(0, 0, 0, 0.25));
    width:3em;}
.start2{
    position: absolute;
    top:size(335);right:size(-32);
    font-size:size(15);
filter: drop-shadow(0em 0.1em 0.15em rgba(0, 0, 0, 0.25));
    width:3em;}
}
