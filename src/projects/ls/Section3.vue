  ...
  <div>
    <div class="section3">
     ...
     <!--  --><div class="pagination absolute flex-ac" v-if="isPC">
      ...
      <div class="txt">
      <div class="title" data-aos="fade-up" data-aos-delay="200">板樹雙核心<br v-if="isMobile" />  鄰近樹林車站</div>
      <div class="desc" data-aos="fade-up" data-aos-delay="300">【樂晴】讀秒即達樹林火車站，特定班次「一站到新板特區」、經城林大橋「一橋抵土城」，快意銜接台65快速道及國道三號，坐享最佳效率。
</div>
      </div>
    </div>
  </div>
