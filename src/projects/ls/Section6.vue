  ...
  <div>
    <div class="section6">
     ...
     <!--  --><div class="pagination absolute flex-ac" v-if="isPC">
      ...
      <div class="txt">
      <div class="title" data-aos="fade-up" data-aos-delay="200">優質名校  勾勒人文閲境</div>
      <div class="desc" data-aos="fade-up" data-aos-delay="300">鄰近溪洲國小、沙崙國小、溪崑國中、樹林高中，孩子上學就讀輕鬆，周邊的書香人文，更能型塑優質居住環境。
</div>
      </div>
    </div>
  </div>
...
.cloud{
  position: absolute;
  bottom:size(130);right:size(-100);
  width:size(500);
}
.txt{
float: right;
...
.cloud{
  bottom:sizem(30);right:sizem(-10);
  width:sizem(220);
}
  .txt{
    width: sizem(335);
