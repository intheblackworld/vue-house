  ...
  <div class="section2 relative">
    <div class="full-bg">
      ...
      >
        ...
        <div v-lazy:background-image="require('./s2/an (4).png')"></div>
        <div v-lazy:background-image="require('./s2/an (5).png')"></div>
        <div v-lazy:background-image="require('./s2/an (6).png')"></div>
