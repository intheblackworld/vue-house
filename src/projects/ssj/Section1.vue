<template>
  <div class="relative">
    <!-- v-if="showIcon"  -->
    <svg v-if="showIcon" version="1.1" preserveAspectRatio="xMinYMax slice" id="svg1" class="svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
    x="0px" y="0px" viewBox="0 0 900 1080" style="enable-background:new 0 0 900 1080;" xml:space="preserve">
      <path
        class="st0 op op11"
    ...
    <svg v-if="showIcon" version="1.1" preserveAspectRatio="xMaxYMax slice" id="svg1-1" class="svg" xmlns="http://www.w3.org/2000/svg" 
    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="1020 -20 900 1080" style="enable-background:new 0 0  900 1080;" xml:space="preserve"   >
      <g class="tr">
    ...
    <svg v-if="showIcon" version="1.1" preserveAspectRatio="xMaxYMax slice" id="svg2-1" class="svg" xmlns="http://www.w3.org/2000/svg"
     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="1020 -20 900 1080" style="enable-background:new 0 0 900 1080" xml:space="preserve"   >
      <g>
...
#svg1 {top:60px;right: 0;width:size(900);
  transform: translate(0, -7%) rotate(180deg);
}
#svg1-1 {top:60px;left: 0;width:size(900);
  transform: translate(0, -7%) rotate(180deg);
}
#svg2 {bottom:0;left: 0;width:size(900);
 //transform: translate(0, -7%) rotate(180deg);
}
#svg2-1 {bottom:0;right: 0;width:size(900);
 // transform: translate(0, -7%) rotate(180deg);
}
.relative {
  height: 100vh;
