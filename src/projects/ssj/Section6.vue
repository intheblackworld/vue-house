<template>
  <div class="relative">
    <div v-if="!isMobile">
      ...
      <div class="desc">
        【樺輝建設，偉康機構】廿年磨一劍，專注完美盡乎苛求。樺輝建設一脈傳承，締造不斐成績。秉持對建築之熱情，對細節之堅持，不畏市場景氣更迭，專注一次只推一案，名宅作品遍及雙北大城，以客為尊。專寵主人家使之稀珍收藏，口碑佳評多年來不曾間歇。
      </div>
      <div
        class="slide relative flex-ac flex-jb"
        data-aos="fade"
        data-aos-delay="400"
      >
        <img
