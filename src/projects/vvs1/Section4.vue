  ...
  <div>
    <div class="section4">
     ...
     <!--  --><div class="pagination absolute flex-ac" data-aos="fade-up" data-aos-delay="500" v-if="isPC">
      ...
      <div class="txt">
      <div class="title" data-aos="fade-up" data-aos-delay="200">文心、青海路口×<br v-if="isMobile" />市政府站</div>
      <div class="subtitle" data-aos="fade-up" data-aos-delay="200">近1500坪黃金角地×<br v-if="isMobile" />青海、漢口、大墩、逢甲商圈</div>
