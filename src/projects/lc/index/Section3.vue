<template>
  <div class="section3">
    ...
    <div class="imgs flex-ac flex-jb">
      ...
      <div class="img" @click="$router.push('/products?index=4')">
      ...
      <div class="img" @click="$router.push('/products?index=5')">
...
.bottom {
  ...
  height: 0;
  border-style: solid;
  border-width: size(320) 0 0 size(1920);
