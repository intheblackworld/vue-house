<template>
  <div>
    <div class="section1">
      ...
      <carousel-3d ref="mycarousel" :width="imgWidth" :height="imgHeight" :autoplay="false" :autoplayTimeout="5000"
        :autoplayHoverPause="true" :perspective="0" :disable3d="isMobile ? false : false" :border="0"
        :display="isMobile ? 3 : 3" :space="isMobile ? 'auto' : 'auto'" @after-slide-change="onAfterSlideChange">
    ...
    <div :class="`section2 ${(currentIndex === 0 || currentIndex === 3) ? 'show' : ''}`">
      <div class="border-container relative">
        ...
        <div class="content-desc">
          以純粹而理性的建築語彙，回應現代產業對效率、秩序與形象的共同需求。框架式立面設計，以淺色基調搭配局部跳色線條，強化視覺層次，勾勒沉穩的建築輪廓，從比例到細節，以務實為本、遠見為度，也象徵企業向前延伸的動能與企圖。

        </div>
        <!-- 
        <a class="btn flex-c" href="https://qianli.tw/" target="_blank">
          聯絡預約
        </a>
...
<br />
    ...
    <div :class="`section2 short ${(currentIndex === 1 || currentIndex === 4) ? 'show' : ''}`">
      <div class="border-container relative">
        ...
        <div class="content-desc">現代框景立面<br />
          垂直之間，理性而內斂線條<br />
          為光與風留下會呼吸的空間<br />
          讓建築回歸純粹<br />
          在后里生活圈<br />
          成為讓時間淬鍊的經典風景
        </div><a class="btn flex-c" href="https://qianli.tw/" target="_blank">
          聯絡預約
        </a>
        <!--  
