    ...
    return {
      ...
      slideList: [
        ...
        },
        {
          ...
          desc:isMobile
            ? '自慢藏擁有水岸公園雙首排的自慢環境，結合都市、建築、人文、動線、自然、生態等元素，，於山水襯底間勾勒出生機豐饒的造景。'
            : '得大山大水之寵，自慢藏擁有水岸公園雙首排的自慢環境，與自然相融，和環境共生，結合都市、建築、人文、動線、自然、生態等元素，擴大生活領域而不侵擾，於山水襯底間勾勒出生機豐饒的造景，及季節多樣性的庭園。',
          work:
