<template>
  <div class="section7">
    ...
    <div class="desc" v-if="isPC" data-aos="fade-up" data-aos-delay="600">
      創立於1951年的JDC日本國土開發株式會社，以確實的工法技術與匠心獨具的營建方式，創造多項世界級重大建設而聞名於世。自慢藏，日本國土開發營造商獻給台北水岸第一次的純日系SRC鋼骨制震豪景觀邸，承襲70年日本血統的嚴謹職人自慢精工，結合SC及RC雙重優勢，CFT柱內灌漿，以高壓灌漿混凝土入鋼柱；採用最高8000磅高強度混凝土，水泥磅數超越法規標準；SA級鋼筋續接器，與捷運、高鐵、台北101享有同等規格的安全守護。日系精工，最高規格，打造台灣水岸最自慢的建築地標。<br /><br />
      【經典業績】<span>東京羽田機場、關西空港、瀨戶大橋、北陸新幹線、三井花園飯店</span>
    </div>
    <div class="desc" v-if="isMobile" data-aos="fade-up" data-aos-delay="600">
      創立於1951年的JDC日本國土開發株式會社，以創造多項世界級重大建設而聞名於世。自慢藏，日本國土開發營造商獻給台北水岸第一次的純日系SRC鋼骨制震豪景觀邸，承襲70年日本血統的嚴謹職人自慢精工，結合SC及RC雙重優勢，CFT柱內灌漿，最高8000磅高強度混凝土，SA級鋼筋續接器，與捷運、高鐵、台北101同等規格的安全守護。日系精工，最高規格，打造台灣水岸最自慢的建築地標。<br /><br />
