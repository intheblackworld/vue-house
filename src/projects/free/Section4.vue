<template>
  <div>
    <div class="section4">
      ...
      <div class="txt">
      <div class="title" data-aos="fade-up" data-aos-delay="200" >市心生活圈  滿分宜居</div>
      <div class="desc" data-aos="fade-up" data-aos-delay="300">享水碓生活圈及中山北路機能，雙生活圈支撐，機能滿分。採買便利，金融銀行、行政中心、大賣場、小超商、傳統市場、公園綠地，5分鐘區域內，生活所需一應俱全。</div>
      </div>
    </div>
  </div>
</template>
