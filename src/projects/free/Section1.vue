   ...
   <div class="img">
    ...
    <div class="txt">
     <svg xmlns="http://www.w3.org/2000/svg" data-aos="zoom-in" data-aos-delay="600" class="logo" viewBox="0 0 675 245" fill="#FFF">
      ...
      <div class="t1"  data-aos="zoom-in" data-aos-delay="600">22-39坪｜稀有地段  即將公開</div>
    </div>
  </div>
</template>
