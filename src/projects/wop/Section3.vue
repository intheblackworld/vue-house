  ...
  <div>
    <div class="section3" v-if="!isMobile">
      <div class="frame absolute-c">
        <img src="./s3/bg.jpg" alt="" class="pic" data-aos="zoom-in" data-aos-delay="200">
        <img src="./s3/bg.png" alt="" class="cloud1" data-aos="zoom-in" data-aos-delay="200">
        <img src="./s3/bg.png" alt="" class="cloud2" data-aos="zoom-in" data-aos-delay="200">
        <img src="./s3/img.png" alt="" class="pic" data-aos="zoom-in" data-aos-delay="200">
      </div>
    </div>
    <div class="section3" v-else>
      <img src="./s3/imgm.png" alt="" class="imgm absolute" data-aos="zoom-in" data-aos-delay="200">
...
.frame {
  width:size(1336);
  height:size(737);text-align: center;
  z-index: 2;
//  max-height: size(855);
  overflow: hidden;
