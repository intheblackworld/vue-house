...
.list{position: absolute;
  ...
  font-weight: 900;
  line-height: 1.3;}
.list1{background: #D32925;
  .img1{@include img_r_pc(200, -5, 0);}
  .img2{
...
.list2{background: #6AA48C;
  .img1{@include img_r_pc(680, -5, 0);}
  .img2{@include img_l_pc(400, 0,290);
  top: auto;
  bottom: 0}
  .img3{@include img_l_pc(340, -5, 0);}
.logo{
...
.t2{
  ...
  color: #000000;
  line-height: 1.3;
  font-size:0.4em;margin:0 0.5em 0 0;
  span{margin: -0.15em 0 0;
  display:block;
  color: #000000;
  font-size:0.9em;}}
}
...
.t2 {
  ...
  .list2{
  .img1{@include img_r_m(270, 0, -10);}
  .img2{
    @include img_r_m(210, 0,-20);
    top: auto;
    bottom: 0;
  }
  .img3{@include img_l_m(150, -50, -10);}
  .logo{
    @include img_l_m(154, 123, 99);
    top: calc(50% - 59vw);
  }
...
.t2 {
  ...
  font-size: sizem(52);
   > span{
  display:block;font-size:0.6em;letter-spacing: 0.04em;margin:0;
 span{
