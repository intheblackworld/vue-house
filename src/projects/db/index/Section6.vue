<template>
  <div class="section6">
    ...
    <img src="./s6/i.jpg" :alt="`${info.caseName}_i`" class="img">
    <img src="./s6/title.png" :alt="`${info.caseName}_title`" class="title-img">
    <img src="./s4/more.png" :alt="`${info.caseName}_more`" class="btn" @click="$router.push('/videos')">
  </div>
</template>
