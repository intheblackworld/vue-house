...
.swipe-item {
  ...
  .caption{position: absolute;
    bottom: .5em;left:.5em;color: #fff;text-shadow: 1px 1px 3px #000c;}
}
...
export default {
    ...
    return {
      ...
      item_list: [
        ...
        },
        {
          ...
          author: '好房網',
          imgs: [
            require('../newimg/18/1.jpg'),
            require('../newimg/18/2.jpg'),
          ],
          desc:
        ...
        },
        {
          ...
          author: '鏡周刊',
          imgs: [
            require('../newimg/17/1.jpg'),
            require('../newimg/17/2.jpg'),
            require('../newimg/17/3.jpg'),
            require('../newimg/17/4.jpg'),
            require('../newimg/17/5.jpg'),
            require('../newimg/17/6.jpg'),
          ],
          desc:
        ...
        },
        {
          ...
          author: '住展房屋網',
          imgs: [
            require('../newimg/14/1.jpg'),
            require('../newimg/14/2.jpg'),
            require('../newimg/14/3.jpg'),
            require('../newimg/14/4.jpg'),
          ],
          desc:
        ...
        },
        {
          ...
          author: 'idSHOW',
          imgs: [
            require('../newimg/13/0.jpg'),
            require('../newimg/13/1.jpg'),
            require('../newimg/13/2.jpg'),
            require('../newimg/13/3.jpg'),
            require('../newimg/13/4.jpg'),
            require('../newimg/13/5.jpg'),
            require('../newimg/13/6.jpg'),
            require('../newimg/13/7.jpg'),
          ],
          desc:
        ...
        },
        {
          ...
          author: 'Yahoo房地產',
          imgs: [
            require('../newimg/12/1.jpg'),
            require('../newimg/12/2.jpg'),
            require('../newimg/12/3.jpg'),
          ],
          desc:
  ...
  created() {
    // Initialize slideList and currentItem based on the route params
  ...
  watch: {
    $route() {
      // Update slideList and currentItem when the route changes
      this.updateDataFromRoute();
    },
  },

  // Methods to keep the component clean and modular
  methods: {
    updateDataFromRoute() {
      const itemId = this.$route.params.id;
      // Ensure itemId is valid, otherwise set a default value or handle it appropriately
      if (itemId >= 0 && itemId < this.item_list.length) {
        this.slideList = this.item_list[itemId].imgs;
        this.currentItem = this.item_list[itemId];
        this.currentNum = Number(itemId);
      } else {
        // Handle invalid itemId, for example, redirect to a default route
