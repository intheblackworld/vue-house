    ...
    return {
      ...
      slideList: [
        /*
        {
          ...
          author: '作',
          imgs: [
            require('../news/s2/4/1.jpg'),
            require('../news/s2/4/2.jpg')
          ],
          desc:
            '111',
          links: [
        ...
        */
        ...
        {
          title: '【經濟日報】住宅安全受重視 中和地標「太陽帝國」全棟採鋼骨結構為換屋首選',
          subtitle: '',
        ...
        //以下為碧波白新聞3篇
        {
          title: '【中時新聞網】MUSE Design Awards得獎公布 台灣之光「碧波白」雙料',
          subtitle: '',
          date: '2020/11/03',
          author: '中時新聞網 朱立君',
          imgs: [
