...
.partical-bg {
  @include div_l_pc(754, 1080, -120, -200);
...
.btn {
  @include div_l_pc(359, 54, 896, 166);
  font-size: size(28.1);
  font-weight: 900;
  font-stretch: normal;
  font-style: normal;
