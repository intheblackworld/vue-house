<template>
  <div>
    <div class="section6">
      ...
      <div class="hint">此為廣告效果示意，為單一建物電腦3D透視表現，周遭環境係電腦合成，建設公司保有建物外觀修正之權利</div>
...
.img {
  @include img_l_pc(412, 685, 190);
}

.desc {
  //@include img_r_pc(440, 816, 170);
  @include img_l_pc(440, 655, 187);
  font-size: size(20);
  font-weight: 500;
  font-stretch: normal;
  font-style: normal;
