  ...
  <div class="section4">
    ...
    <transition-group name="fade-up" mode="out-in">
      ...
      <div v-if="blockIndex === 1" key="block1">
        <img src="./s4/04_img.png" :alt="`${info.caseName}_img`" class="img">
        <div class="hr"></div>
        <img src="./s4/04-2_title_1.png" :alt="`${info.caseName}_img`" class="title1" v-if="blockIndex === 1">
        <img src="./s4/04-2_title_2.png" :alt="`${info.caseName}_img`" class="title2" v-if="blockIndex === 1">
        <div class="desc">
