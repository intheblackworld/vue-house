<template>
  <div class="section9">
    ...
    <svg version="1.1" :class="`text-box ${position === 0 ? 'left': ''} ${position === 2 ? 'right': ''}`" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1203 431" style="enable-background:new 0 0 1203 431;" xml:space="preserve"  v-if="viewIndex === 9 || viewIndex === 11">
    ...
    <div :class="`list flex-ac flex-jb ${position === 0 ? 'left': ''} ${position === 2 ? 'right': ''}`">
      <div class="item flex-c wrap" data-aos="fade-top" data-aos-delay="600">
        ...
        <div class="item-desc">
          五股市區、新市鎮、<br />
          <span class="orange">新莊副都心、洲子洋</span><br />
          生活機能全包
        </div>
      </div>
      <div class="item flex-c wrap" data-aos="fade-top" data-aos-delay="600">
        ...
        <div class="item-desc">
          雙北各大城暢行無阻，<br />
          <span class="pink">「3高3捷4特快」</span><br />
          交通機能全包
        </div>
      </div>
      <div class="item flex-c wrap" data-aos="fade-top" data-aos-delay="600">
...
.section9 {
  width: 100%;
  height: 100vh;
  min-height: size(1008);
  max-height: size(1008);
  //overflow: hidden;
  position: relative;
...
.text-box {
  ...
  .st22 {
    ...
    stroke-linecap: round;
    stroke-linejoin: round;
    stroke-dasharray: 0.999, 14.9855;
  }
  .st23 {
    fill: none;
    stroke: #f1ffff;
...
.list {
  ...
  .item-hr {
    width: size(227);
    border-bottom: solid 1.3px #4d4d4d;
    margin: size(8) 0;
  }
...
@media screen and (max-width: 767px) {
  .section9 {
    width: 100vw;
    min-height: sizem(726);
    max-height: sizem(726);
    height: sizem(726);
...
export default {
  ...
  methods: {
    add() {
      this.position = this.position !== 2 ? this.position + 1 : this.position
    },
