<template>
  <div class="section2">
    ...
    <div class="video video-dialog" v-if="isDialog && isMobile">
      <div class="video_box">
        <iframe title="youtube" src="https://www.youtube.com/embed/bsbhsUrAOoU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
