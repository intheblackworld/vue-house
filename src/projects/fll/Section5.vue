    ...
    return {
      ...
      slideList: [
        ...
        },
        {
          ...
          area: "",
          subtitle: '銀力淨乳膠漆',
          desc: '台灣精工品牌，榮獲綠建材標章，通過日本JIS Z2911防霉測試，無添加甲醛、鉛、汞等八大重金屬。微米級抗菌銀離子：有效抑制6百多種細菌。<br />持久抗菌，不受時間、日照、水洗影響抗菌效果。<br />珪藻土：由珪藻的細胞壁沉積而成。多孔性的結構，可幫忙吸收濕度、隔熱、噪音、吸收廢氣以提高室內空氣品質。',
        }
      ]
    };
  },
