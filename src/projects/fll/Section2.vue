<template>
  <div class="section2">
    ...
    <div class="video video-dialog" v-if="isDialog">
      ...
      <div class="video-bg">
        <div class="video_box">
          <iframe title="youtube" src="https://www.youtube.com/embed/b_5BLmJ0tbo" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
