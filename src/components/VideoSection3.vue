  ...
  <div class="section3">
    <!-- <div class="bg fullscreen">
      ...
      >
        ...
        >
          <img
            src="@/projects/jh/s3/play_btn.png"
            alt
      ...
      <div class="btn-group flex-jb flex-ac flex-mobile-jb" v-if="isMobile">
        <img @click="goToSlide(currentIndex - 1)" src="@/projects/jh/arrow-left.png" alt />
        <img @click="goToSlide(currentIndex + 1)" src="@/projects/jh/arrow-right.png" alt />
      </div>
    </div> -->
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      slideList: [
        {
          // img: require('@/projects/jh/s3/1.jpg'),
          video: '',
          isPlay: false,
        },
        {
          // img: require('@/projects/jh/s3/2.jpg'),
          video: '',
          isPlay: false,
        },
        {
          // img: require('@/projects/jh/s3/4.jpg'),
          video: '',
          isPlay: false,
        },
      ],
