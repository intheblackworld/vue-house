<template>
  <div>
   ...
   <!--   <div class="logobg1"></div>
      ...
      <img src="@/projects/rjs/s1/logobg2.png" :alt="`${info.caseName}_近捷運`" />
      <img src="@/projects/rjs/s1/logobg3.png" :alt="`${info.caseName}_鄰公園`" />
      <img src="@/projects/rjs/s1/logobg1.png" :alt="`${info.caseName}_蘆洲站5分鐘`" />
      <img src="@/projects/rjs/s1/logobg2.png" :alt="`${info.caseName}_888萬起`" />
      <img src="@/projects/rjs/s1/logobg3.png" :alt="`${info.caseName}_快樂王國`" />
      </div>
-->
