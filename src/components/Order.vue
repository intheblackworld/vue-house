      ...
      <div class="order">
        ...
        <div class="hint">
          ...
          <ol>
            ...
            <li>客戶管理與服務。</li>
            <li>本公司行銷業務之推廣。</li>
            <li>即刻預約至109.7.31截止，需填寫完整個人資料，並至接待中心完成參觀，即可獲得抽獎券一張。</li>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      fetch(
        `https://script.google.com/macros/s/AKfycbyQKCOhxPqCrLXWdxsAaAH06Zwz_p6mZ5swK80USQ/exec?name=${this.form.name}&phone=${this.form.phone}&email=${this.form.email}&cityarea=${this.form.city}${this.form.area}&msg=${this.form.msg}&utm_source=${utmSource}&utm_medium=${utmMedium}&utm_content=${utmContent}&utm_campaign=${utmCampaign}&date=${date}&campaign_name=${info.caseName}&time_start=${this.form.time_start}&time_end=${this.form.time_end}
      `,
        {
          method: 'GET',
        },
