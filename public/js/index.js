...
function mobileSwiperText() {
    const text = [
        ...
        '以往到日本朝聖全球最美書店「蔦屋書店」，現在在家就<br>能享受，台南首座與台灣蔦屋書店TSUTAYABOOKSTORE<br>攜手打造，將現代和風生活提案帶入〔西門大院〕書香人<br>文空間，包括四季大花園、台灣蔦屋書房、健身房、兒童<br>遊戲閱覽室、才藝教室、閱覽室、空中花園等豐富的樂齡<br>共享休閒設施。',
